...
export default function Home() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      getNearbyPlaces({
        ...
        category,
        radius: radiusKm,
        // Widening the range should surface more places
  ...
  // Switching units keeps the real distance
  ...
  // Attach the closest documented restroom
  ...
  // The restroom list is already filtered server-side
