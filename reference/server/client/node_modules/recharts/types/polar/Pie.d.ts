...
import { ActiveShape, AnimationDuration, ChartOffsetInternal, Coordinate, DataConsumer, DataKey, DataProvider, EasingInput, GeometrySector, LegendType, PolarLayout, PresentationAttributesAdaptChildEvent, ShapeAnimationProps, TooltipType } from 'recharts/types/util/types';
import { TooltipTriggerInfo } from 'recharts/types/context/tooltipContext';
import { Formatter } from 'recharts/types/component/DefaultTooltipContent';
import { DATA_ITEM_GRAPHICAL_ITEM_ID_ATTRIBUTE_NAME, DATA_ITEM_INDEX_ATTRIBUTE_NAME } from 'recharts/types/util/Constants';
import { AnimationInterpolateFn } from 'recharts/types/animation/AnimatedItems';
import { AnimationMatchByProp } from 'recharts/types/animation/matchBy';
...
export declare const defaultPieProps: {
    ...
    readonly shape: React.FC<import("recharts").SectorProps>;
